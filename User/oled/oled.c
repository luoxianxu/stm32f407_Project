...
void WriteOLedCmd(uint8_t cmd)
{
	...
	iic_send_byte_data(0x78); 	//发送从设备地址
	iic_getack();
	
	iic_send_byte_data(CtrWord); //发送命令控制字
	iic_getack();
	
	iic_send_byte_data(cmd);
	iic_getack();
...
//uint8_t HZ14[]={0x10,0x60,0x02,0x8C,0x00,0xFE,0x92,0x92,0x92,0x92,0x92,0x92,0xFE,0x00,0x00,0x00,
//0x04,0x04,0x7E,0x01,0x44,0x48,0x50,0x7F,0x40,0x40,0x7F,0x50,0x48,0x44,0x40,0x00};/*"湿",0*/

//uint8_t HZ15[]={0x00,0x00,0xFC,0x24,0x24,0x24,0xFC,0x25,0x26,0x24,0xFC,0x24,0x24,0x24,0x04,0x00,
//0x40,0x30,0x8F,0x80,0x84,0x4C,0x55,0x25,0x25,0x25,0x55,0x4C,0x80,0x80,0x80,0x00};/*"度",1*/

//uint8_t HZ16[]={0x10,0x60,0x02,0x8C,0x00,0x00,0xFE,0x92,0x92,0x92,0x92,0x92,0xFE,0x00,0x00,0x00,
//0x04,0x04,0x7E,0x01,0x40,0x7E,0x42,0x42,0x7E,0x42,0x7E,0x42,0x42,0x7E,0x40,0x00};/*"温",2*/

uint8_t HZ19[]={0x00,0x80,0x60,0xF8,0x07,0x40,0x48,0x48,0xE8,0x5F,0x48,0x48,0x48,0x40,0x40,0x00,
0x01,0x00,0x00,0xFF,0x00,0x00,0x02,0x0B,0x12,0x22,0xD2,0x0A,0x06,0x00,0x00,0x00};/*"小",0*/

uint8_t HZ20[]={0x20,0x30,0xAC,0x63,0x30,0x00,0x88,0xC8,0xA8,0x99,0x8E,0x88,0xA8,0xC8,0x88,0x00,
0x22,0x67,0x22,0x12,0x12,0x80,0x40,0x30,0x0F,0x00,0x00,0x3F,0x40,0x40,0x71,0x00};/*"小",0*/

uint8_t HZ21[]={0x04,0x04,0x44,0xC4,0x4F,0x44,0x44,0xC4,0x24,0x24,0x2F,0xB4,0x24,0x04,0x04,0x00,
0x40,0x44,0x24,0x24,0x15,0x0C,0x04,0xFE,0x04,0x0C,0x15,0x24,0x24,0x44,0x40,0x00};/*"菜",1*/

uint8_t HZ22[]={0x00,0xFE,0x02,0x42,0x4A,0xCA,0x4A,0x4A,0xCA,0x4A,0x4A,0x42,0x02,0xFE,0x00,0x00,
...
//		//第1行显示重量
//		OLed_ShowChina(16,0,HZ14);
//		OLed_ShowChina(32,0,HZ15);
////		OLed_Fill(0x00);//描点清屏函数；
//		while(1);
//		return 0 ;
//}
...
{
	//第2行显示光照	
	OLed_ShowChina(16,0,HZ19);
	OLed_ShowChina(32,0,HZ20);
	OLed_ShowChina(48,0,HZ21);
	OLed_ShowChina(64,0,HZ22);
	OLed_ShowChina(16,2,HZ6);
	OLed_ShowChina(32,2,HZ7);
	OLed_ShowChina(16,4,HZ1);
	OLed_ShowChina(32,4,HZ2);
	OLed_ShowChina(16,6,HZ3);
	OLed_ShowChina(32,6,HZ2);
}
